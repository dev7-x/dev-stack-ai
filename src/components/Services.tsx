...
const services = [
  {
    ...
    skills: ["LLM Agents", "RAG Workflows", "Chatbots", "Claude/OpenAI", "Python", "Gen AI", "MCP"],
  ...
  },
  {
    ...
    skills: ["Next.js", "React", "TypeScript", "Node.js", "Java", "AWS/Azure/GCP", "Docker", "API"],
  ...
  },
  {
    ...
    skills: ["Snowflake", "Databricks", "Apache Spark", "Kafka", "Power BI", "SQL", "Airflow"],
